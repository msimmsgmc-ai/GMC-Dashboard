...
export const actuals: Actual[] = [
  ...
  // ── Q2 2026 (complete: April – June) ────────────────────────────────
  // Updated from Box Score generated 09/02/2026.
  // Jordan Station = East (300 rentable) + West (236 rentable) combined.
  {
    propertyId: "jordan_station", year: 2026, quarter: "Q2",
    periodLabel: "04/01/2026 – 06/30/2026",
    occupancy: 498 / 536, occupancyStart: null,
    totalLeadsStart: 3518, moveInsStart: 185, moveOutsStart: 243,
    tourRateStart: 0.155, ltmiStart: 0.053,
    notReadyStart: 35, denialRateStart: null,
    totalLeads: 793, totalTours: 251,
    moveIns: 106, moveOuts: 81, evictions: 0,
    tourRate: 251 / 793, ltmi: 106 / 793,
    notReady: 35, denialRate: 5 / 122,
    rentableUnits: 536, occupiedUnits: 498, vacantUnits: 38,
  },
  {
    propertyId: "oakleaf", year: 2026, quarter: "Q2",
    periodLabel: "04/01/2026 – 06/30/2026",
    occupancy: 323 / 354, occupancyStart: null,
    totalLeadsStart: 1183, moveInsStart: 101, moveOutsStart: 134,
    tourRateStart: 0.149, ltmiStart: 0.085,
    notReadyStart: 20, denialRateStart: 0.29,
    totalLeads: 396, totalTours: 118,
    moveIns: 51, moveOuts: 36, evictions: 0,
    tourRate: 118 / 396, ltmi: 51 / 396,
    notReady: 9, denialRate: 14 / 70,
    rentableUnits: 354, occupiedUnits: 323, vacantUnits: 31,
  },
  {
    propertyId: "oakview", year: 2026, quarter: "Q2",
    periodLabel: "04/01/2026 – 06/30/2026",
    occupancy: 180 / 215, occupancyStart: 0.833,
    totalLeadsStart: 2200, moveInsStart: 116, moveOutsStart: 129,
    tourRateStart: 0.101, ltmiStart: 0.05,
    notReadyStart: 26, denialRateStart: 0.33,
    totalLeads: 405, totalTours: 77,
    moveIns: 31, moveOuts: 27, evictions: 8,
    tourRate: 77 / 405, ltmi: 31 / 405,
    notReady: 23, denialRate: 14 / 53,
    rentableUnits: 215, occupiedUnits: 180, vacantUnits: 35,
  },
  {
    propertyId: "pier5350", year: 2026, quarter: "Q2",
    periodLabel: "04/01/2026 – 06/30/2026",
    occupancy: 350 / 398, occupancyStart: null,
    totalLeadsStart: null, moveInsStart: null, moveOutsStart: null,
    tourRateStart: null, ltmiStart: null,
    notReadyStart: 26, denialRateStart: null,
    totalLeads: 1555, totalTours: 177,
    moveIns: 43, moveOuts: 41, evictions: 3,
    tourRate: 177 / 1555, ltmi: 43 / 1555,
    notReady: 15, denialRate: 12 / 103,
    rentableUnits: 398, occupiedUnits: 350, vacantUnits: 48,
  },
  {
    propertyId: "hendricks", year: 2026, quarter: "Q2",
    periodLabel: "04/01/2026 – 06/30/2026",
    occupancy: 118 / 132, occupancyStart: null,
    totalLeadsStart: 536, moveInsStart: 67, moveOutsStart: 74,
    tourRateStart: 0.534, ltmiStart: 0.125,
    notReadyStart: 6, denialRateStart: 0.04,
    totalLeads: 171, totalTours: 78,
    moveIns: 15, moveOuts: 21, evictions: 0,
    tourRate: 78 / 171, ltmi: 15 / 171,
    notReady: 9, denialRate: 1 / 25,
...
export const financials: PropertyFinancials[] = [
  ...
  {
    // Jordan Station I+II = Jordan Station + Jordan Station West combined
    propertyId: "jordan_station", year: 2026, quarter: "Q2",
    monthLabel: "Apr – Jun 2026", ytdLabel: "Jan – Jun 2026",
    lines: [
      { label: "Total Income",         monthActual: 2606865.82, monthBudget: 2626007.00, ytdActual: 5093231.58, ytdBudget: 5151022.50 },
      { label: "Personnel",            monthActual:  207887.89, monthBudget:  172287.00, ytdActual:  420019.96, ytdBudget:  387630.00 },
      { label: "Repair & Maintenance", monthActual:   28466.82, monthBudget:   36426.00, ytdActual:   63657.33, ytdBudget:   72257.00 },
      { label: "Outside Service",      monthActual:   79162.42, monthBudget:   90605.00, ytdActual:  157253.56, ytdBudget:  172688.00 },
      { label: "NOI",                  monthActual: 1590044.58, monthBudget: 1626808.00, ytdActual: 3057985.60, ytdBudget: 3120619.50 },
      { label: "CapEx",                monthActual:   44846.94, monthBudget:   26962.50, ytdActual:  139902.75, ytdBudget:  112290.00 },
    ],
  },
  {
    propertyId: "oakleaf", year: 2026, quarter: "Q2",
    monthLabel: "Apr – Jun 2026", ytdLabel: "Jan – Jun 2026",
    lines: [
      { label: "Total Income",         monthActual: 1353119.78, monthBudget: 1463570.51, ytdActual: 2804857.29, ytdBudget: 2891881.02 },
      { label: "Personnel",            monthActual:  163735.65, monthBudget:  141897.00, ytdActual:  306020.01, ytdBudget:  305768.00 },
      { label: "Repair & Maintenance", monthActual:   24894.94, monthBudget:   30477.00, ytdActual:   54392.75, ytdBudget:   62604.00 },
      { label: "Outside Service",      monthActual:  102291.08, monthBudget:   72010.00, ytdActual:  159170.76, ytdBudget:  150431.00 },
      { label: "NOI",                  monthActual:  586173.62, monthBudget:  744406.51, ytdActual: 1320736.19, ytdBudget: 1410405.02 },
      { label: "CapEx",                monthActual:  103997.19, monthBudget:  151198.00, ytdActual:  309590.54, ytdBudget:  377580.00 },
    ],
  },
  {
    propertyId: "oakview", year: 2026, quarter: "Q2",
    monthLabel: "Apr – Jun 2026", ytdLabel: "Jan – Jun 2026",
    lines: [
      { label: "Total Income",         monthActual: 727656.39, monthBudget: 833826.00, ytdActual: 1479096.93, ytdBudget: 1607987.00 },
      { label: "Personnel",            monthActual: 104904.87, monthBudget:  68568.00, ytdActual:  192920.73, ytdBudget:  147402.00 },
      { label: "Repair & Maintenance", monthActual:  24776.86, monthBudget:  16230.00, ytdActual:   44880.76, ytdBudget:   35860.00 },
      { label: "Outside Service",      monthActual:  48711.30, monthBudget:  40884.00, ytdActual:  129542.25, ytdBudget:   98096.00 },
      { label: "NOI",                  monthActual: 257935.23, monthBudget: 416888.00, ytdActual:  533182.46, ytdBudget:  743862.00 },
      { label: "CapEx",                monthActual:  35272.30, monthBudget:  40520.00, ytdActual:   91474.09, ytdBudget:   84990.00 },
    ],
  },
  {
    propertyId: "pier5350", year: 2026, quarter: "Q2",
    monthLabel: "Apr – Jun 2026", ytdLabel: "Jan – Jun 2026",
    lines: [
      { label: "Total Income",         monthActual: 1414780.10, monthBudget: 1514602.00, ytdActual: 2870870.04, ytdBudget: 3016006.00 },
      { label: "Personnel",            monthActual:  183470.45, monthBudget:  161049.00, ytdActual:  331160.31, ytdBudget:  344965.00 },
      { label: "Repair & Maintenance", monthActual:   42850.66, monthBudget:   31153.00, ytdActual:   73417.77, ytdBudget:   62816.00 },
      { label: "Outside Service",      monthActual:   97229.62, monthBudget:  111530.00, ytdActual:  176201.71, ytdBudget:  216565.00 },
      { label: "NOI",                  monthActual:  612146.47, monthBudget:  679950.00, ytdActual: 1438548.76, ytdBudget: 1412761.00 },
      { label: "CapEx",                monthActual:  313845.53, monthBudget:   79005.00, ytdActual:  459530.69, ytdBudget:  139435.00 },
    ],
  },
  {
    propertyId: "hendricks", year: 2026, quarter: "Q2",
    monthLabel: "Apr – Jun 2026", ytdLabel: "Jan – Jun 2026",
    lines: [
      { label: "Total Income",         monthActual: 740817.80, monthBudget: 730434.00, ytdActual: 1458484.93, ytdBudget: 1449869.00 },
      { label: "Personnel",            monthActual:  71773.33, monthBudget:  65196.00, ytdActual:  138461.82, ytdBudget:  140062.00 },
      { label: "Repair & Maintenance", monthActual:   9445.56, monthBudget:   6614.00, ytdActual:   15670.98, ytdBudget:   13403.00 },
      { label: "Outside Service",      monthActual:  22221.72, monthBudget:  24208.00, ytdActual:   45129.62, ytdBudget:   48796.00 },
      { label: "NOI",                  monthActual: 373561.84, monthBudget: 373326.00, ytdActual:  729973.52, ytdBudget:  735628.00 },
      { label: "CapEx",                monthActual:   1504.35, monthBudget:   2512.00, ytdActual:    9405.33, ytdBudget:    9274.00 },
    ],
  },
];
